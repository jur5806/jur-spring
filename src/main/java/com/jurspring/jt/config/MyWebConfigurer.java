...
public class MyWebConfigurer implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/**")
                ...
                .allowedOrigins("http://192.168.43.1:8080","http://localhost:8080","http://localhost:8081")
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/march/file/**").addResourceLocations("file:" + "d:/workspace/img/");
    }
