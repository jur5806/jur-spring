...
public class resumeinfoController {
    ...
    public Result getByhrIdList(Integer hrId,Integer recruitId,Integer state) {
        return ResultFactory.buildSuccessResult(resumeInfoService.getByHrId(hrId,recruitId,state));
    }
